...
const clients = [
  {
    name: "Seplat Energy",
    logoUrl: "https://placehold.co/120x60/3b82f6/ffffff?text=Seplat",
    link: "#",
  },
  {
    name: "CAP Plc",
    logoUrl: "https://placehold.co/120x60/10b981/ffffff?text=CAP",
    link: "#",
  },
  {
    name: "UNICEF",
    logoUrl: "https://placehold.co/120x60/9333ea/ffffff?text=UNICEF",
    link: "#",
  },
  {
    name: "FanMilk",
    logoUrl: "https://placehold.co/120x60/f59e0b/ffffff?text=FanMilk",
    link: "#",
  },
  {
    name: "TSL Logistics",
    logoUrl: "https://placehold.co/120x60/ef4444/ffffff?text=TSL",
    link: "#",
  },
  {
    name: "May & Baker",
    logoUrl: "https://placehold.co/120x60/6366f1/ffffff?text=M&B",
    link: "#",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              The credibility of our competencies can be validated by observing
              our portfolio of distinguished clients and the success stories
              we've delivered across various sectors.
            </p>
            <Link
              href="/projects"
              className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium text-lg transition duration-300"
            >
              View Full Portfolio
              <svg
